...
namespace SharpXNA
{
    public class Textures
    {
        ...
        public Textures(string rootDirectory) { _assets = new Dictionary<string, Texture2D>(); RootDirectory = rootDirectory; }
        ...
        public void LoadAll(string path = null)
        {
            ...
            foreach (var file in files)
            {
                ...
                using (var fs = new FileStream(file, FileMode.Open, FileAccess.Read, FileShare.Read)) Add(Texture2D.FromStream(Engine.GraphicsDevice, fs), name);
            }
        }
