...
namespace SharpXNA
{
    public class Batch
    {
        ...
        public void Begin() { Begin(SpriteSortMode.Deferred, null, null, null, null, null, null); }
        ...
        public void Begin(SpriteSortMode sortMode, BlendState blendState) { Begin(sortMode, blendState, null, null, null, null, null); }
        ...
        public void Begin(SpriteSortMode sortMode, BlendState blendState, SamplerState samplerState) { Begin(sortMode, blendState, samplerState, null, null, null, null); }
        ...
        public void Begin(SpriteSortMode sortMode, BlendState blendState, DepthStencilState depthStencilState) { Begin(sortMode, blendState, null, depthStencilState, null, null, null); }
        ...
        public void Begin(SpriteSortMode sortMode, BlendState blendState, SamplerState samplerState, DepthStencilState depthStencilState) { Begin(sortMode, blendState, samplerState, depthStencilState, null, null, null); }
        ...
        public void Begin(SpriteSortMode sortMode, BlendState blendState, RasterizerState rasterizerState) { Begin(sortMode, blendState, null, null, rasterizerState, null, null); }
        ...
        public void Begin(SpriteSortMode sortMode, BlendState blendState, SamplerState samplerState, RasterizerState rasterizerState) { Begin(sortMode, blendState, samplerState, null, rasterizerState, null, null); }
        ...
        public void Begin(SpriteSortMode sortMode, BlendState blendState, DepthStencilState depthStencilState, RasterizerState rasterizerState) { Begin(sortMode, blendState, null, depthStencilState, rasterizerState, null, null); }
        ...
        public void Begin(SpriteSortMode sortMode, BlendState blendState, SamplerState samplerState, DepthStencilState depthStencilState, RasterizerState rasterizerState) { Begin(sortMode, blendState, samplerState, depthStencilState, rasterizerState, null, null); }
        ...
        public void Begin(SpriteSortMode sortMode, BlendState blendState, Effect effect) { Begin(sortMode, blendState, null, null, null, effect, null); }
        ...
        public void Begin(SpriteSortMode sortMode, BlendState blendState, SamplerState samplerState, Effect effect) { Begin(sortMode, blendState, samplerState, null, null, effect, null); }
        ...
        public void Begin(SpriteSortMode sortMode, BlendState blendState, DepthStencilState depthStencilState, Effect effect) { Begin(sortMode, blendState, null, depthStencilState, null, effect, null); }
        ...
        public void Begin(SpriteSortMode sortMode, BlendState blendState, SamplerState samplerState, DepthStencilState depthStencilState, Effect effect) { Begin(sortMode, blendState, samplerState, depthStencilState, null, effect, null); }
        ...
        public void Begin(SpriteSortMode sortMode, BlendState blendState, RasterizerState rasterizerState, Effect effect) { Begin(sortMode, blendState, null, null, rasterizerState, effect, null); }
        ...
        public void Begin(SpriteSortMode sortMode, BlendState blendState, SamplerState samplerState, Effect effect, RasterizerState rasterizerState) { Begin(sortMode, blendState, samplerState, null, rasterizerState, effect, null); }
        ...
        public void Begin(SpriteSortMode sortMode, BlendState blendState, DepthStencilState depthStencilState, RasterizerState rasterizerState, Effect effect) { Begin(sortMode, blendState, null, depthStencilState, rasterizerState, effect, null); }
        ...
        public void Begin(SpriteSortMode sortMode, BlendState blendState, SamplerState samplerState, DepthStencilState depthStencilState, RasterizerState rasterizerState, Effect effect, Matrix? matrix = null) { this.sortMode = sortMode; Begun = true; spriteBatch.Begin(sortMode, blendState, samplerState, depthStencilState, rasterizerState, effect, matrix); }
        public void End() { Begun = false; spriteBatch.End(); }

        public void Draw(string texture, Vector2 position) { Draw(Load(texture), position, null, Color.White, 0, Origin.None, Vector2.One, SpriteEffects.None, 0); }
        public void Draw(string texture, Vector2 position, SpriteEffects effect, float layer) { Draw(Load(texture), position, null, Color.White, 0, Origin.None, Vector2.One, effect, layer); }
        public void Draw(string texture, Vector2 position, Rectangle? source) { Draw(Load(texture), position, source, Color.White, 0, Origin.None, Vector2.One, SpriteEffects.None, 0); }
        public void Draw(string texture, Vector2 position, Rectangle? source, SpriteEffects effect, float layer) { Draw(Load(texture), position, source, Color.White, 0, Origin.None, Vector2.One, effect, layer); }
        ...
        public void Draw(string texture, Vector2 position, Color tint) { Draw(Load(texture), position, null, tint, 0, Origin.None, Vector2.One, SpriteEffects.None, 0); }
        public void Draw(string texture, Vector2 position, Color tint, SpriteEffects effect, float layer) { Draw(Load(texture), position, null, tint, 0, Origin.None, Vector2.One, effect, layer); }
        public void Draw(string texture, Vector2 position, Rectangle? source, Color tint) { Draw(Load(texture), position, source, tint, 0, Origin.None, Vector2.One, SpriteEffects.None, 0); }
        public void Draw(string texture, Vector2 position, Rectangle? source, Color tint, SpriteEffects effect, float layer) { Draw(Load(texture), position, source, tint, 0, Origin.None, Vector2.One, effect, layer); }
        ...
        public void Draw(string texture, Rectangle bounds) { Draw(Load(texture), bounds, null, Color.White, 0, Origin.None, SpriteEffects.None, 0); }
        public void Draw(string texture, Rectangle bounds, SpriteEffects effect, float layer) { Draw(Load(texture), bounds, null, Color.White, 0, Origin.None, effect, layer); }
        public void Draw(string texture, Rectangle bounds, Rectangle? source) { Draw(Load(texture), bounds, source, Color.White, 0, Origin.None, SpriteEffects.None, 0); }
        public void Draw(string texture, Rectangle bounds, Rectangle? source, SpriteEffects effect, float layer) { Draw(Load(texture), bounds, source, Color.White, 0, Origin.None, effect, layer); }
        public void Draw(string texture, Vector2 position, Vector2 scale) { Draw(Load(texture), position, null, Color.White, 0, Origin.None, scale, SpriteEffects.None, 0); }
        public void Draw(string texture, Vector2 position, Vector2 scale, float layer) { Draw(Load(texture), position, null, Color.White, 0, Origin.None, scale, SpriteEffects.None, layer); }
        public void Draw(string texture, Vector2 position, Vector2 scale, SpriteEffects effect, float layer) { Draw(Load(texture), position, null, Color.White, 0, Origin.None, scale, effect, layer); }
        public void Draw(string texture, Vector2 position, Rectangle? source, Vector2 scale) { Draw(Load(texture), position, source, Color.White, 0, Origin.None, scale, SpriteEffects.None, 0); }
        public void Draw(string texture, Vector2 position, Rectangle? source, Vector2 scale, float layer) { Draw(Load(texture), position, source, Color.White, 0, Origin.None, scale, SpriteEffects.None, layer); }
        public void Draw(string texture, Vector2 position, Rectangle? source, Vector2 scale, SpriteEffects effect, float layer) { Draw(Load(texture), position, source, Color.White, 0, Origin.None, scale, effect, layer); }
        ...
        public void Draw(string texture, Rectangle bounds, Color tint) { Draw(Load(texture), bounds, null, tint, 0, Origin.None, SpriteEffects.None, 0); }
        public void Draw(string texture, Rectangle bounds, Color tint, SpriteEffects effect, float layer) { Draw(Load(texture), bounds, null, tint, 0, Origin.None, effect, layer); }
        public void Draw(string texture, Rectangle bounds, Rectangle? source, Color tint) { Draw(Load(texture), bounds, source, tint, 0, Origin.None, SpriteEffects.None, 0); }
        public void Draw(string texture, Rectangle bounds, Rectangle? source, Color tint, SpriteEffects effect, float layer) { Draw(Load(texture), bounds, source, tint, 0, Origin.None, effect, layer); }
        public void Draw(string texture, Vector2 position, Color tint, Vector2 scale) { Draw(Load(texture), position, null, tint, 0, Origin.None, scale, SpriteEffects.None, 0); }
        public void Draw(string texture, Vector2 position, Color tint, Vector2 scale, float layer) { Draw(Load(texture), position, null, tint, 0, Origin.None, scale, SpriteEffects.None, layer); }
        public void Draw(string texture, Vector2 position, Color tint, Vector2 scale, SpriteEffects effect, float layer) { Draw(Load(texture), position, null, tint, 0, Origin.None, scale, effect, layer); }
        public void Draw(string texture, Vector2 position, Rectangle? source, Color tint, Vector2 scale) { Draw(Load(texture), position, source, tint, 0, Origin.None, scale, SpriteEffects.None, 0); }
        public void Draw(string texture, Vector2 position, Rectangle? source, Color tint, Vector2 scale, float layer) { Draw(Load(texture), position, source, tint, 0, Origin.None, scale, SpriteEffects.None, layer); }
        public void Draw(string texture, Vector2 position, Rectangle? source, Color tint, Vector2 scale, SpriteEffects effect, float layer) { Draw(Load(texture), position, source, tint, 0, Origin.None, scale, effect, layer); }
        ...
        public void Draw(string texture, Vector2 position, Origin origin) { Draw(Load(texture), position, null, Color.White, 0, origin, Vector2.One, SpriteEffects.None, 0); }
        public void Draw(string texture, Vector2 position, Origin origin, float layer) { Draw(Load(texture), position, null, Color.White, 0, origin, Vector2.One, SpriteEffects.None, layer); }
        public void Draw(string texture, Vector2 position, Origin origin, SpriteEffects effect, float layer) { Draw(Load(texture), position, null, Color.White, 0, origin, Vector2.One, effect, layer); }
        public void Draw(string texture, Vector2 position, Rectangle? source, Origin origin) { Draw(Load(texture), position, source, Color.White, 0, origin, Vector2.One, SpriteEffects.None, 0); }
        public void Draw(string texture, Vector2 position, Rectangle? source, Origin origin, float layer) { Draw(Load(texture), position, source, Color.White, 0, origin, Vector2.One, SpriteEffects.None, layer); }
        public void Draw(string texture, Vector2 position, Rectangle? source, Origin origin, SpriteEffects effect, float layer) { Draw(Load(texture), position, source, Color.White, 0, origin, Vector2.One, effect, layer); }
        ...
        public void Draw(string texture, Vector2 position, Color tint, Origin origin) { Draw(Load(texture), position, null, tint, 0, origin, Vector2.One, SpriteEffects.None, 0); }
        public void Draw(string texture, Vector2 position, Color tint, Origin origin, float layer) { Draw(Load(texture), position, null, tint, 0, origin, Vector2.One, SpriteEffects.None, layer); }
        public void Draw(string texture, Vector2 position, Color tint, Origin origin, SpriteEffects effect, float layer) { Draw(Load(texture), position, null, tint, 0, origin, Vector2.One, effect, layer); }
        public void Draw(string texture, Vector2 position, Rectangle? source, Color tint, Origin origin) { Draw(Load(texture), position, source, tint, 0, origin, Vector2.One, SpriteEffects.None, 0); }
        public void Draw(string texture, Vector2 position, Rectangle? source, Color tint, Origin origin, float layer) { Draw(Load(texture), position, source, tint, 0, origin, Vector2.One, SpriteEffects.None, layer); }
        public void Draw(string texture, Vector2 position, Rectangle? source, Color tint, Origin origin, SpriteEffects effect, float layer) { Draw(Load(texture), position, source, tint, 0, origin, Vector2.One, effect, layer); }
        ...
        public void Draw(string texture, Rectangle bounds, Origin origin) { Draw(Load(texture), bounds, null, Color.White, 0, origin, SpriteEffects.None, 0); }
        public void Draw(string texture, Rectangle bounds, Origin origin, float layer) { Draw(Load(texture), bounds, null, Color.White, 0, origin, SpriteEffects.None, layer); }
        public void Draw(string texture, Rectangle bounds, Origin origin, SpriteEffects effect, float layer) { Draw(Load(texture), bounds, null, Color.White, 0, origin, effect, layer); }
        public void Draw(string texture, Rectangle bounds, Rectangle? source, Origin origin) { Draw(Load(texture), bounds, source, Color.White, 0, origin, SpriteEffects.None, 0); }
        public void Draw(string texture, Rectangle bounds, Rectangle? source, Origin origin, float layer) { Draw(Load(texture), bounds, source, Color.White, 0, origin, SpriteEffects.None, layer); }
        public void Draw(string texture, Rectangle bounds, Rectangle? source, Origin origin, SpriteEffects effect, float layer) { Draw(Load(texture), bounds, source, Color.White, 0, origin, effect, layer); }
        public void Draw(string texture, Vector2 position, Origin origin, Vector2 scale) { Draw(Load(texture), position, null, Color.White, 0, origin, scale, SpriteEffects.None, 0); }
        public void Draw(string texture, Vector2 position, Origin origin, Vector2 scale, float layer) { Draw(Load(texture), position, null, Color.White, 0, origin, scale, SpriteEffects.None, layer); }
        public void Draw(string texture, Vector2 position, Origin origin, Vector2 scale, SpriteEffects effect, float layer) { Draw(Load(texture), position, null, Color.White, 0, origin, scale, effect, layer); }
        public void Draw(string texture, Vector2 position, Rectangle? source, Origin origin, Vector2 scale) { Draw(Load(texture), position, source, Color.White, 0, origin, scale, SpriteEffects.None, 0); }
        public void Draw(string texture, Vector2 position, Rectangle? source, Origin origin, Vector2 scale, float layer) { Draw(Load(texture), position, source, Color.White, 0, origin, scale, SpriteEffects.None, layer); }
        public void Draw(string texture, Vector2 position, Rectangle? source, Origin origin, Vector2 scale, SpriteEffects effect, float layer) { Draw(Load(texture), position, source, Color.White, 0, origin, scale, effect, layer); }
        ...
        public void Draw(string texture, Rectangle bounds, Color tint, Origin origin) { Draw(Load(texture), bounds, null, tint, 0, origin, SpriteEffects.None, 0); }
        public void Draw(string texture, Rectangle bounds, Color tint, Origin origin, float layer) { Draw(Load(texture), bounds, null, tint, 0, origin, SpriteEffects.None, layer); }
        public void Draw(string texture, Rectangle bounds, Color tint, Origin origin, SpriteEffects effect, float layer) { Draw(Load(texture), bounds, null, tint, 0, origin, effect, layer); }
        public void Draw(string texture, Rectangle bounds, Rectangle? source, Color tint, Origin origin) { Draw(Load(texture), bounds, source, tint, 0, origin, SpriteEffects.None, 0); }
        public void Draw(string texture, Rectangle bounds, Rectangle? source, Color tint, Origin origin, float layer) { Draw(Load(texture), bounds, source, tint, 0, origin, SpriteEffects.None, layer); }
        public void Draw(string texture, Rectangle bounds, Rectangle? source, Color tint, Origin origin, SpriteEffects effect, float layer) { Draw(Load(texture), bounds, source, tint, 0, origin, effect, layer); }
        public void Draw(string texture, Vector2 position, Color tint, Origin origin, Vector2 scale) { Draw(Load(texture), position, null, tint, 0, origin, scale, SpriteEffects.None, 0); }
        public void Draw(string texture, Vector2 position, Color tint, Origin origin, Vector2 scale, float layer) { Draw(Load(texture), position, null, tint, 0, origin, scale, SpriteEffects.None, layer); }
        public void Draw(string texture, Vector2 position, Color tint, Origin origin, Vector2 scale, SpriteEffects effect, float layer) { Draw(Load(texture), position, null, tint, 0, origin, scale, effect, layer); }
        public void Draw(string texture, Vector2 position, Rectangle? source, Color tint, Origin origin, Vector2 scale) { Draw(Load(texture), position, source, tint, 0, origin, scale, SpriteEffects.None, 0); }
        public void Draw(string texture, Vector2 position, Rectangle? source, Color tint, Origin origin, Vector2 scale, float layer) { Draw(Load(texture), position, source, tint, 0, origin, scale, SpriteEffects.None, layer); }
        public void Draw(string texture, Vector2 position, Rectangle? source, Color tint, Origin origin, Vector2 scale, SpriteEffects effect, float layer) { Draw(Load(texture), position, source, tint, 0, origin, scale, effect, layer); }
        ...
        public void Draw(string texture, Vector2 position, float angle) { Draw(Load(texture), position, null, Color.White, angle, Origin.None, Vector2.One, SpriteEffects.None, 0); }
        public void Draw(string texture, Vector2 position, float angle, float layer) { Draw(Load(texture), position, null, Color.White, angle, Origin.None, Vector2.One, SpriteEffects.None, layer); }
        public void Draw(string texture, Vector2 position, float angle, SpriteEffects effect, float layer) { Draw(Load(texture), position, null, Color.White, angle, Origin.None, Vector2.One, effect, layer); }
        public void Draw(string texture, Vector2 position, Rectangle? source, float angle) { Draw(Load(texture), position, source, Color.White, angle, Origin.None, Vector2.One, SpriteEffects.None, 0); }
        public void Draw(string texture, Vector2 position, Rectangle? source, float angle, float layer) { Draw(Load(texture), position, source, Color.White, angle, Origin.None, Vector2.One, SpriteEffects.None, layer); }
        public void Draw(string texture, Vector2 position, Rectangle? source, float angle, SpriteEffects effect, float layer) { Draw(Load(texture), position, source, Color.White, angle, Origin.None, Vector2.One, effect, layer); }
        ...
        public void Draw(string texture, Vector2 position, Color tint, float angle) { Draw(Load(texture), position, null, tint, angle, Origin.None, Vector2.One, SpriteEffects.None, 0); }
        public void Draw(string texture, Vector2 position, Color tint, float angle, float layer) { Draw(Load(texture), position, null, tint, angle, Origin.None, Vector2.One, SpriteEffects.None, layer); }
        public void Draw(string texture, Vector2 position, Color tint, float angle, SpriteEffects effect, float layer) { Draw(Load(texture), position, null, tint, angle, Origin.None, Vector2.One, effect, layer); }
        public void Draw(string texture, Vector2 position, Rectangle? source, Color tint, float angle) { Draw(Load(texture), position, source, tint, angle, Origin.None, Vector2.One, SpriteEffects.None, 0); }
        public void Draw(string texture, Vector2 position, Rectangle? source, Color tint, float angle, float layer) { Draw(Load(texture), position, source, tint, angle, Origin.None, Vector2.One, SpriteEffects.None, layer); }
        public void Draw(string texture, Vector2 position, Rectangle? source, Color tint, float angle, SpriteEffects effect, float layer) { Draw(Load(texture), position, source, tint, angle, Origin.None, Vector2.One, effect, layer); }
        ...
        public void Draw(string texture, Rectangle bounds, float angle) { Draw(Load(texture), bounds, null, Color.White, angle, Origin.None, SpriteEffects.None, 0); }
        public void Draw(string texture, Rectangle bounds, float angle, float layer) { Draw(Load(texture), bounds, null, Color.White, angle, Origin.None, SpriteEffects.None, layer); }
        public void Draw(string texture, Rectangle bounds, float angle, SpriteEffects effect, float layer) { Draw(Load(texture), bounds, null, Color.White, angle, Origin.None, effect, layer); }
        public void Draw(string texture, Rectangle bounds, Rectangle? source, float angle) { Draw(Load(texture), bounds, source, Color.White, angle, Origin.None, SpriteEffects.None, 0); }
        public void Draw(string texture, Rectangle bounds, Rectangle? source, float angle, float layer) { Draw(Load(texture), bounds, source, Color.White, angle, Origin.None, SpriteEffects.None, layer); }
        public void Draw(string texture, Rectangle bounds, Rectangle? source, float angle, SpriteEffects effect, float layer) { Draw(Load(texture), bounds, source, Color.White, angle, Origin.None, effect, layer); }
        public void Draw(string texture, Vector2 position, float angle, Vector2 scale) { Draw(Load(texture), position, null, Color.White, angle, Origin.None, scale, SpriteEffects.None, 0); }
        public void Draw(string texture, Vector2 position, float angle, Vector2 scale, float layer) { Draw(Load(texture), position, null, Color.White, angle, Origin.None, scale, SpriteEffects.None, layer); }
        public void Draw(string texture, Vector2 position, float angle, Vector2 scale, SpriteEffects effect, float layer) { Draw(Load(texture), position, null, Color.White, angle, Origin.None, scale, effect, layer); }
        public void Draw(string texture, Vector2 position, Rectangle? source, float angle, Vector2 scale) { Draw(Load(texture), position, source, Color.White, angle, Origin.None, scale, SpriteEffects.None, 0); }
        public void Draw(string texture, Vector2 position, Rectangle? source, float angle, Vector2 scale, float layer) { Draw(Load(texture), position, source, Color.White, angle, Origin.None, scale, SpriteEffects.None, layer); }
        public void Draw(string texture, Vector2 position, Rectangle? source, float angle, Vector2 scale, SpriteEffects effect, float layer) { Draw(Load(texture), position, source, Color.White, angle, Origin.None, scale, effect, layer); }
        ...
        public void Draw(string texture, Rectangle bounds, Color tint, float angle) { Draw(Load(texture), bounds, null, tint, angle, Origin.None, SpriteEffects.None, 0); }
        public void Draw(string texture, Rectangle bounds, Color tint, float angle, float layer) { Draw(Load(texture), bounds, null, tint, angle, Origin.None, SpriteEffects.None, layer); }
        public void Draw(string texture, Rectangle bounds, Color tint, float angle, SpriteEffects effect, float layer) { Draw(Load(texture), bounds, null, tint, angle, Origin.None, effect, layer); }
        public void Draw(string texture, Rectangle bounds, Rectangle? source, Color tint, float angle) { Draw(Load(texture), bounds, source, tint, angle, Origin.None, SpriteEffects.None, 0); }
        public void Draw(string texture, Rectangle bounds, Rectangle? source, Color tint, float angle, float layer) { Draw(Load(texture), bounds, source, tint, angle, Origin.None, SpriteEffects.None, layer); }
        public void Draw(string texture, Rectangle bounds, Rectangle? source, Color tint, float angle, SpriteEffects effect, float layer) { Draw(Load(texture), bounds, source, tint, angle, Origin.None, effect, layer); }
        public void Draw(string texture, Vector2 position, Color tint, float angle, Vector2 scale) { Draw(Load(texture), position, null, tint, angle, Origin.None, scale, SpriteEffects.None, 0); }
        public void Draw(string texture, Vector2 position, Color tint, float angle, Vector2 scale, float layer) { Draw(Load(texture), position, null, tint, angle, Origin.None, scale, SpriteEffects.None, layer); }
        public void Draw(string texture, Vector2 position, Color tint, float angle, Vector2 scale, SpriteEffects effect, float layer) { Draw(Load(texture), position, null, tint, angle, Origin.None, scale, effect, layer); }
        public void Draw(string texture, Vector2 position, Rectangle? source, Color tint, float angle, Vector2 scale) { Draw(Load(texture), position, source, tint, angle, Origin.None, scale, SpriteEffects.None, 0); }
        public void Draw(string texture, Vector2 position, Rectangle? source, Color tint, float angle, Vector2 scale, float layer) { Draw(Load(texture), position, source, tint, angle, Origin.None, scale, SpriteEffects.None, layer); }
        public void Draw(string texture, Vector2 position, Rectangle? source, Color tint, float angle, Vector2 scale, SpriteEffects effect, float layer) { Draw(Load(texture), position, source, tint, angle, Origin.None, scale, effect, layer); }
        ...
        public void Draw(string texture, Vector2 position, float angle, Origin origin) { Draw(Load(texture), position, null, Color.White, angle, origin, Vector2.One, SpriteEffects.None, 0); }
        public void Draw(string texture, Vector2 position, float angle, Origin origin, float layer) { Draw(Load(texture), position, null, Color.White, angle, origin, Vector2.One, SpriteEffects.None, layer); }
        public void Draw(string texture, Vector2 position, float angle, Origin origin, SpriteEffects effect, float layer) { Draw(Load(texture), position, null, Color.White, angle, origin, Vector2.One, effect, layer); }
        public void Draw(string texture, Vector2 position, Rectangle? source, float angle, Origin origin) { Draw(Load(texture), position, source, Color.White, angle, origin, Vector2.One, SpriteEffects.None, 0); }
        public void Draw(string texture, Vector2 position, Rectangle? source, float angle, Origin origin, float layer) { Draw(Load(texture), position, source, Color.White, angle, origin, Vector2.One, SpriteEffects.None, layer); }
        public void Draw(string texture, Vector2 position, Rectangle? source, float angle, Origin origin, SpriteEffects effect, float layer) { Draw(Load(texture), position, source, Color.White, angle, origin, Vector2.One, effect, layer); }
        ...
        public void Draw(string texture, Vector2 position, Color tint, float angle, Origin origin) { Draw(Load(texture), position, null, tint, angle, origin, Vector2.One, SpriteEffects.None, 0); }
        public void Draw(string texture, Vector2 position, Color tint, float angle, Origin origin, float layer) { Draw(Load(texture), position, null, tint, angle, origin, Vector2.One, SpriteEffects.None, layer); }
        public void Draw(string texture, Vector2 position, Color tint, float angle, Origin origin, SpriteEffects effect, float layer) { Draw(Load(texture), position, null, tint, angle, origin, Vector2.One, effect, layer); }
        public void Draw(string texture, Vector2 position, Rectangle? source, Color tint, float angle, Origin origin) { Draw(Load(texture), position, source, tint, angle, origin, Vector2.One, SpriteEffects.None, 0); }
        public void Draw(string texture, Vector2 position, Rectangle? source, Color tint, float angle, Origin origin, float layer) { Draw(Load(texture), position, source, tint, angle, origin, Vector2.One, SpriteEffects.None, layer); }
        public void Draw(string texture, Vector2 position, Rectangle? source, Color tint, float angle, Origin origin, SpriteEffects effect, float layer) { Draw(Load(texture), position, source, tint, angle, origin, Vector2.One, effect, layer); }
        ...
        public void Draw(string texture, Rectangle bounds, float angle, Origin origin) { Draw(Load(texture), bounds, null, Color.White, angle, origin, SpriteEffects.None, 0); }
        public void Draw(string texture, Rectangle bounds, float angle, Origin origin, float layer) { Draw(Load(texture), bounds, null, Color.White, angle, origin, SpriteEffects.None, layer); }
        public void Draw(string texture, Rectangle bounds, float angle, Origin origin, SpriteEffects effect, float layer) { Draw(Load(texture), bounds, null, Color.White, angle, origin, effect, layer); }
        public void Draw(string texture, Rectangle bounds, Rectangle? source, float angle, Origin origin) { Draw(Load(texture), bounds, source, Color.White, angle, origin, SpriteEffects.None, 0); }
        public void Draw(string texture, Rectangle bounds, Rectangle? source, float angle, Origin origin, float layer) { Draw(Load(texture), bounds, source, Color.White, angle, origin, SpriteEffects.None, layer); }
        public void Draw(string texture, Rectangle bounds, Rectangle? source, float angle, Origin origin, SpriteEffects effect, float layer) { Draw(Load(texture), bounds, source, Color.White, angle, origin, effect, layer); }
        public void Draw(string texture, Vector2 position, float angle, Origin origin, Vector2 scale) { Draw(Load(texture), position, null, Color.White, angle, origin, scale, SpriteEffects.None, 0); }
        public void Draw(string texture, Vector2 position, float angle, Origin origin, Vector2 scale, float layer) { Draw(Load(texture), position, null, Color.White, angle, origin, scale, SpriteEffects.None, layer); }
        public void Draw(string texture, Vector2 position, float angle, Origin origin, Vector2 scale, SpriteEffects effect, float layer) { Draw(Load(texture), position, null, Color.White, angle, origin, scale, effect, layer); }
        public void Draw(string texture, Vector2 position, Rectangle? source, float angle, Origin origin, Vector2 scale) { Draw(Load(texture), position, source, Color.White, angle, origin, scale, SpriteEffects.None, 0); }
        public void Draw(string texture, Vector2 position, Rectangle? source, float angle, Origin origin, Vector2 scale, float layer) { Draw(Load(texture), position, source, Color.White, angle, origin, scale, SpriteEffects.None, layer); }
        public void Draw(string texture, Vector2 position, Rectangle? source, float angle, Origin origin, Vector2 scale, SpriteEffects effect, float layer) { Draw(Load(texture), position, source, Color.White, angle, origin, scale, effect, layer); }
        ...
        public void Draw(string texture, Rectangle bounds, Color tint, float angle, Origin origin) { Draw(Load(texture), bounds, null, tint, angle, origin, SpriteEffects.None, 0); }
        public void Draw(string texture, Rectangle bounds, Color tint, float angle, Origin origin, float layer) { Draw(Load(texture), bounds, null, tint, angle, origin, SpriteEffects.None, layer); }
        public void Draw(string texture, Rectangle bounds, Color tint, float angle, Origin origin, SpriteEffects effect, float layer) { Draw(Load(texture), bounds, null, tint, angle, origin, effect, layer); }
        public void Draw(string texture, Rectangle bounds, Rectangle? source, Color tint, float angle, Origin origin) { Draw(Load(texture), bounds, source, tint, angle, origin, SpriteEffects.None, 0); }
        public void Draw(string texture, Rectangle bounds, Rectangle? source, Color tint, float angle, Origin origin, float layer) { Draw(Load(texture), bounds, source, tint, angle, origin, SpriteEffects.None, layer); }
        public void Draw(string texture, Rectangle bounds, Rectangle? source, Color tint, float angle, Origin origin, SpriteEffects effect, float layer) { Draw(Load(texture), bounds, source, tint, angle, origin, effect, layer); }
        public void Draw(string texture, Vector2 position, Color tint, float angle, Origin origin, Vector2 scale) { Draw(Load(texture), position, null, tint, angle, origin, scale, SpriteEffects.None, 0); }
        public void Draw(string texture, Vector2 position, Color tint, float angle, Origin origin, Vector2 scale, float layer) { Draw(Load(texture), position, null, tint, angle, origin, scale, SpriteEffects.None, layer); }
        public void Draw(string texture, Vector2 position, Color tint, float angle, Origin origin, Vector2 scale, SpriteEffects effect, float layer) { Draw(Load(texture), position, null, tint, angle, origin, scale, effect, layer); }
        public void Draw(string texture, Vector2 position, Rectangle? source, Color tint, float angle, Origin origin, Vector2 scale) { Draw(Load(texture), position, source, tint, angle, origin, scale, SpriteEffects.None, 0); }
        public void Draw(string texture, Vector2 position, Rectangle? source, Color tint, float angle, Origin origin, Vector2 scale, float layer) { Draw(Load(texture), position, source, tint, angle, origin, scale, SpriteEffects.None, layer); }
        public void Draw(string texture, Vector2 position, Rectangle? source, Color tint, float angle, Origin origin, Vector2 scale, SpriteEffects effect, float layer) { Draw(Load(texture), position, source, tint, angle, origin, scale, effect, layer); }
        ...
        public void Draw(Texture2D texture, Rectangle bounds, Rectangle? source, Color tint, float angle, Origin origin, SpriteEffects effect, float layer) { origin.ApplyScale(texture, source); spriteBatch.Draw(texture, bounds, source, tint, angle, origin.Value, effect, layer); }
        ...
        public void Draw(Texture2D texture, Vector2 position, Rectangle? source, Color tint, float angle, Origin origin, Vector2 scale, SpriteEffects effect, float layer) { origin.ApplyScale(texture, source); spriteBatch.Draw(texture, position, source, tint, angle, origin.Value, scale, effect, layer); }
        ...
        public void FillRectangle(Rectangle bounds, Color fill) { Draw(Pixel(Color.White, true), bounds, fill, 0, Origin.None, 0); }
        public void FillRectangle(Rectangle bounds, Color fill, float layer) { Draw(Pixel(Color.White, true), bounds, fill, 0, Origin.None, layer); }
        ...
        {
            Draw(Pixel(Color.White, true), new Vector2((bounds.X + bounds.Width), bounds.Y), stroke, 0, new Origin(.5f, 0, true), new Vector2(thickness, bounds.Height), layer);
            Draw(Pixel(Color.White, true), new Vector2((bounds.X + bounds.Width), (bounds.Y + bounds.Height)), stroke, MathHelper.ToRadians(180), new Origin(0, .5f, true), new Vector2(bounds.Width, thickness), layer);
            Draw(Pixel(Color.White, true), new Vector2(bounds.X, (bounds.Y + bounds.Height)), stroke, MathHelper.ToRadians(180), new Origin(.5f, 0, true), new Vector2(thickness, bounds.Height), layer);
            Draw(Pixel(Color.White, true), new Vector2(bounds.X, bounds.Y), stroke, 0, new Origin(0, .5f, true), new Vector2(bounds.Width, thickness), layer);
        }
        ...
        {
            Draw(Pixel(Color.White, true), bounds, fill, 0, Origin.None, layer);
            Draw(Pixel(Color.White, true), new Vector2((bounds.X + bounds.Width), bounds.Y), stroke, 0, new Origin(.5f, 0, true), new Vector2(thickness, bounds.Height), layer);
            Draw(Pixel(Color.White, true), new Vector2((bounds.X + bounds.Width), (bounds.Y + bounds.Height)), stroke, MathHelper.ToRadians(180), new Origin(0, .5f, true), new Vector2(bounds.Width, thickness), layer);
            Draw(Pixel(Color.White, true), new Vector2(bounds.X, (bounds.Y + bounds.Height)), stroke, MathHelper.ToRadians(180), new Origin(.5f, 0, true), new Vector2(thickness, bounds.Height), layer);
            Draw(Pixel(Color.White, true), new Vector2(bounds.X, bounds.Y), stroke, 0, new Origin(0, .5f, true), new Vector2(bounds.Width, thickness), layer);
        ...
        public void DrawLine(Vector2 start, Vector2 end, Color color, float thickness, SpriteEffects effect, float layer) { Draw(Pixel(Color.White, true), start, null, color, Globe.Angle(start, end), new Origin(0, .5f, true), new Vector2(MathHelper.Max(1, Vector2.Distance(start, end)), thickness), effect, layer); }
    }
}